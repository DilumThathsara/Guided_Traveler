...
class sabaragamuwaProvince extends StatefulWidget {
  const sabaragamuwaProvince({Key? key}) : super(key: key);
  @override
  State<sabaragamuwaProvince> createState() => _sabaragamuwaProvinceState();
}

class _sabaragamuwaProvinceState extends State<sabaragamuwaProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/sabaragamuwa.json');
