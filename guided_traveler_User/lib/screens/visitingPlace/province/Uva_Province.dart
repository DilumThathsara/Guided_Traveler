...
class UvaProvince extends StatefulWidget {
  const UvaProvince({Key? key}) : super(key: key);
  @override
  State<UvaProvince> createState() => _UvaProvinceState();
}

class _UvaProvinceState extends State<UvaProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/UvaProvince.json');
