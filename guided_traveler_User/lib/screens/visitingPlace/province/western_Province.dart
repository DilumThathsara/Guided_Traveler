...
class westernProvince extends StatefulWidget {
  const westernProvince({Key? key}) : super(key: key);
  @override
  State<westernProvince> createState() => _westernProvinceState();
}

class _westernProvinceState extends State<westernProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/westernProvince.json');
