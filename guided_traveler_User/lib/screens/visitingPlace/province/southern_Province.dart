...
class southernProvince extends StatefulWidget {
  const southernProvince({Key? key}) : super(key: key);
  @override
  State<southernProvince> createState() => _southernProvinceState();
}

class _southernProvinceState extends State<southernProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/southernProvince.json');
