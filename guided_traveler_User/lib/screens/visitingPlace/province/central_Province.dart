...
class centralProvince extends StatefulWidget {
  const centralProvince({Key? key}) : super(key: key);
  @override
  State<centralProvince> createState() => _centralProvinceState();
}

class _centralProvinceState extends State<centralProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/centralProvince.json');
