...
class northWesternProvince extends StatefulWidget {
  const northWesternProvince({Key? key}) : super(key: key);
  @override
  State<northWesternProvince> createState() => _northWesternProvinceState();
}

class _northWesternProvinceState extends State<northWesternProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response = await rootBundle
        .loadString('assets/jsonFile/NorthWesternProvince.json');
