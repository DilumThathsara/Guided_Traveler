...
class easternProvince extends StatefulWidget {
  const easternProvince({Key? key}) : super(key: key);
  @override
  State<easternProvince> createState() => _easternProvinceState();
}

class _easternProvinceState extends State<easternProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/easternProvince.json');
