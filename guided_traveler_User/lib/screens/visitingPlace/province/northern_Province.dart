...
class northernProvince extends StatefulWidget {
  const northernProvince({Key? key}) : super(key: key);
  @override
  State<northernProvince> createState() => _northernProvinceState();
}

class _northernProvinceState extends State<northernProvince> {
  List items = [];
  // Fetch content from the json file
  Future<void> readJson() async {
    final String response =
        await rootBundle.loadString('assets/jsonFile/NorthernProvince.json');
