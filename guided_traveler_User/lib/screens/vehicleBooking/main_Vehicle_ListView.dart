...
import 'package:guided_traveler/screens/vehicleBooking/without_Driver.dart';
import 'package:guided_traveler/utils/app_Colors.dart';
import 'package:guided_traveler/utils/util_Functions.dart';

class mainVehicleListView extends StatefulWidget {
  mainVehicleListView({Key? key}) : super(key: key);
  @override
  State<mainVehicleListView> createState() => _mainVehicleListViewState();
}

class _mainVehicleListViewState extends State<mainVehicleListView> {
  int _currentIndex = 0;
