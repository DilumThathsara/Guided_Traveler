...
class withDriverDetails extends StatefulWidget {
  const withDriverDetails({super.key});

  @override
  State<withDriverDetails> createState() => _withDriverDetailsState();
}

class _withDriverDetailsState extends State<withDriverDetails> {
  @override
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomText(
                            value.getWithDriverModel.vehicleName,
                          ...
                          Row(
                            ...
                            children: [
                              CustomText(
                                value.getWithDriverModel.vehicleType,
                                fontSize: 20,
                                fontWeight: FontWeight.w500,
                                color: Colors.black54,
                              ),
                              CustomText(
                                value.getWithDriverModel.vehicleNo,
                                fontSize: 20,
                                fontWeight: FontWeight.w500,
                                color: Colors.black54,
                              ),
                          ...
                          CustomText(
                            "Vehicle Owner Phone Number : " +
                                value.getWithDriverModel.vehiclePhoneNo,
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                            color: Colors.black,
                          ...
                          CustomText(
                            "Vehicle Email : " +
                                value.getWithDriverModel.vehicleEmail,
                            fontSize: 18,
                            fontWeight: FontWeight.w500,
                            color: Colors.black,
                            textAlign: TextAlign.justify,
                        ...
                        customButton(
                            onTap: () {
                              utillFunction.navigateTo(context,
                                  const withDriverVehicleBookingForm());
                            },
                            text: "Booking"),
                        const SizedBox(
                          height: 250,
